...
export async function apply(db: Pool): Promise<void> {
    ...
    await db.query(
        `CREATE TABLE uploads (
            ...
            label       ENUM('001', '002', '014', '017', '023', '027', '078', '106', '181', '207', '651', 'other') CHARACTER SET ascii DEFAULT NULL,
    ...
    await db.query(
        `CREATE TABLE samples (
            ...
            dt_result                ENUM('027', '181', 'other') CHARACTER SET ascii DEFAULT NULL COMMENT 'Has no confidence',
